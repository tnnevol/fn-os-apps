...
export const dshSemiClientDeps = {
  ...
  alias: {
    ...
    '@douyinfe/semi-ui/navigation': join(semiUiRoot, 'lib/es/navigation/index.js'),
    ...
    '@douyinfe/semi-ui/lib/es/skeleton/index': join(semiUiRoot, 'lib/es/skeleton/index.js'),
    ...
    '@douyinfe/semi-ui/lib/es/table/index': join(semiUiRoot, 'lib/es/table/index.js'),
    '@douyinfe/semi-ui/lib/es/card/index': join(semiUiRoot, 'lib/es/card/index.js'),
    '@douyinfe/semi-ui/lib/es/empty/index': join(semiUiRoot, 'lib/es/empty/index.js'),
    '@douyinfe/semi-ui/lib/es/descriptions/index': join(semiUiRoot, 'lib/es/descriptions/index.js'),
    '@douyinfe/semi-ui/lib/es/layout/index': join(semiUiRoot, 'lib/es/layout/index.js'),
    '@douyinfe/semi-ui/lib/es/select/index': join(semiUiRoot, 'lib/es/select/index.js'),
    '@douyinfe/semi-ui/lib/es/list/index': join(semiUiRoot, 'lib/es/list/index.js'),
    '@douyinfe/semi-ui/lib/es/tabs/index': join(semiUiRoot, 'lib/es/tabs/index.js'),
    '@douyinfe/semi-ui/lib/es/badge/index': join(semiUiRoot, 'lib/es/badge/index.js'),
    '@douyinfe/semi-ui/lib/es/avatar/index': join(semiUiRoot, 'lib/es/avatar/index.js'),
    ...
    '@douyinfe/semi-icons/lib/es/icons/IconEdit.js': join(semiIconsRoot, 'lib/es/icons/IconEdit.js'),
    ...
    '@douyinfe/semi-icons/lib/es/icons/IconMore.js': join(semiIconsRoot, 'lib/es/icons/IconMore.js'),

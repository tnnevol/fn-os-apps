...
type CodexWebRuntimeStatus = CodexWebAuthStatus & {
  dshVersion: string
}

export function withDshVersion(status: CodexWebAuthStatus): CodexWebRuntimeStatus {
  return { ...status, dshVersion: APP_IDENTITY.version }
}

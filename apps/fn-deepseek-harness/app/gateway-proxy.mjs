...
function gatewayBridgeScript() {
    return [
        ...
        '    let connection;',
        '    // Cordis runs apply() while the providing fiber is still loading.',
        '    // The default strict lookup hides that service until the fiber becomes',
        '    // ACTIVE, so use the non-strict lookup after ctx.provide() has registered',
        '    // the handle. This is the point where the gateway can safely mark it.',
        ...
        '        // switches from its pending queue to the live registry. Re-wrap',
        '        // that new method before immediate bundles (including connection)',
        '        // are prefetched and registered.',

<template>
  <header class="app-header">
    <div class="logo-area">
      <img src="/image.png" alt="Logo" class="h-6 w-6 object-contain rounded" />
      <h1 class="app-title">OpenList 管理面板</h1>
    </div>
    <el-tooltip :content="isDark ? '切换浅色' : '切换暗黑'" placement="bottom">
